...
class _MyAppState extends State<MyApp> {
  ...
  final String _clientId = '[client ID]';
  final String _redirectUrl = 'bankiddemo://callback';
  final String _issuer = '[IDP]';
  final String _discoveryUrl = '[IDP]/.well-known/openid-configuration';
  final String _postLogoutRedirectUrl = 'bankiddemo://logout';
  ...
  final AuthorizationServiceConfiguration _serviceConfiguration =
    ...
    authorizationEndpoint: '[IDP]/connect/authorize',
    tokenEndpoint: '[IDP]/connect/token',
    endSessionEndpoint: '[IDP]/connect/endsession',
  );
  ...
  Future<void> _testApi(TokenResponse? response) async {
    final http.Response httpResponse = await http.get(
        Uri.parse('[your api server]/api/test'),
